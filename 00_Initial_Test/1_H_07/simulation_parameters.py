...
if space_charge_flag:
        ...
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../Initial_Distns/' + str(parameters['n_macroparticles']) + '/1_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../Initial_Distns/' + str(parameters['n_macroparticles']) + '/1_V_24/bunch_output/mainbunch_-000001.mat'
else:
        switches['Space_Charge'] = False
        if transverse_plane == 'H': 
                parameters['input_distn'] = '../Initial_Distns/' + str(parameters['n_macroparticles']) + '/0_H_21/bunch_output/mainbunch_-000001.mat'
        else:
                parameters['input_distn'] = '../Initial_Distns/' + str(parameters['n_macroparticles']) + '/0_V_24/bunch_output/mainbunch_-000001.mat'
